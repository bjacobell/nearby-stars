...
h5_path = '/datag/pipeline/AGBT20B_999_40/collate2/spliced_blc00010203040506o7o0111213141516o7o0212223242526o7o031323334353637_guppi_59174_29578_And_XVI_0081.rawspec.0000.h5'

#center_frequencies = np.concatenate(
#    (np.arange(1800+0.02, 2300, 0.02), np.arange(2360+0.02, 2700, 0.02))
#)
center_frequencies = np.arange(4000+0.02, 7800, 0.02)
...
fb_new.write_to_hdf5('/datax/scratch/benjb/bliss_LSCX_test/power_law/C/spliced_blc00010203040506o7o0111213141516o7o0212223242526o7o031323334353637_guppi_59174_29578_And_XVI_0081.rawspec.0000.h5')
np.save('/datax/scratch/benjb/bliss_LSCX_test/power_law/C/injections_freq_DR_snr_widths_ANDXVI_0081.npy', np.array([center_frequencies, drift_rates, snrs, widths]))
