...
h5_path = '/datag/pipeline/AGBT19B_999_113/collate0/spliced_blc00010203040506o7o0111213141516o7o021222324252627_guppi_58810_25902_And_XVI_0073.gpuspec.0000.h5'

#center_frequencies = np.concatenate(
#    (np.arange(1800+0.02, 2300, 0.02), np.arange(2360+0.02, 2700, 0.02))
#)
center_frequencies = np.arange(7800+0.02, 11200, 0.02)
...
fb_new.write_to_hdf5('/datax/scratch/benjb/bliss_LSCX_test/power_law/X/spliced_blc00010203040506o7o0111213141516o7o021222324252627_guppi_58810_25902_And_XVI_0073.gpuspec.0000.h5')
np.save('/datax/scratch/benjb/bliss_LSCX_test/power_law/X/injections_freq_DR_snr_widths_ANDXVI_0073.npy', np.array([center_frequencies, drift_rates, snrs, widths]))
