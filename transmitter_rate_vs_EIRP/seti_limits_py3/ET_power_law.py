...
def ET_power_law(verbose=False):
    ...
    #   S: Green        NOAH: RED
    #   C: Orange       NOAH: GREEN
    #   X: Blue         NOAH: ORANGE, all of this was changed in the additional file color_coded_ET_power_law.py
    ...
    #-------
    enriquez, = plt.plot([np.log10(BL_EIRP)],[np.log10(1./BL_rarity)],'h', color = 'dodgerblue',markeredgecolor = 'none', markersize = markersize)
